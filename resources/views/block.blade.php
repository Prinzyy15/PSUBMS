            ...
            <table id="list" class="table table-hover table-borderless shadow-sm rounded">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><button class="btn badge badge-danger btn-delete-block" data-id="{{ $b->block_id }}"><img src="{{ asset('images/trash.png') }}" style="height: 35px;"/> </button> <button data-id="{{ $b->block_id }}" class="btn badge badge-info btn-get-block" data-toggle="modal" data-target="#updateBlockModal"><img src="{{ asset('images/edit.png') }}" style="height: 35px;"/> </button></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
