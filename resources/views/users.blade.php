                    ...
                    <tr>
                        ...
                        <td>
                            @if(\Auth::user()->role === 'admin' && \Auth::user()->id !== $u->id )
                               <button class="btn badge badge-danger btn-delete-user" data-id="{{ $u->id }}" aria-label="Delete user">
                            ...
                            @endif
                            <button data-toggle="modal" data-target="#updateUserModal" class="btn badge badge-info btn-get-user" data-id="{{ $u->id }}" aria-label="Edit user">
